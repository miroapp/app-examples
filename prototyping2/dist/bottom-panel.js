/******/ ;(function (modules) {
	...
	/******/ [
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
			...
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'APP_ID', function () {
				return APP_ID
			})
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'EDIT_WIDTH', function () {
				return EDIT_WIDTH
			})
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'PLAY_WIDTH', function () {
				return PLAY_WIDTH
			})
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
			...
			/* harmony import */ var copy_to_clipboard__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(
				copy_to_clipboard__WEBPACK_IMPORTED_MODULE_0__
			)
			...
			/* harmony import */ var react_inlinesvg__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/ __webpack_require__.n(
			...
			var HOTSPOT_PREVIEW =
				"data:image/svg+xml,%3Csvg width='152' height='66' xmlns='http://www.w3.org/2000/svg'%3E%3Cg%3E%3Crect stroke='null' x='0' y='0' fill-opacity='0.5' fill='%232d9bf0' height='140' width='140'/%3E%3C/g%3E%3C/svg%3E"
			var Root = /** @class */ (function (_super) {
				...
				function Root() {
					...
					_this.onCanvasClicked = function (e) {
						return __awaiter(_this, void 0, void 0, function () {
							var widgets, hotspot, screenWidget, screenIndex
							return __generator(this, function (_a) {
								switch (_a.label) {
									case 0:
										return [4 /*yield*/, miro.board.widgets.__getIntersectedObjects(e.data)]
									case 1:
										widgets = _a.sent()
										...
										return [
											4 /*yield*/,
											Object(bottom_panel_controller__WEBPACK_IMPORTED_MODULE_3__['goToWidgetFromHotspot'])(hotspot.id),
										]
									case 2:
					...
					_this.getLink = function () {
						miro.board.__getBoardURLWithParams({runPrototyping: true}).then(function (url) {
				...
				Root.prototype.componentDidMount = function () {
					...
					var options = {
						...
						onDrop: function (canvasX, canvasY) {
							Object(bottom_panel_controller__WEBPACK_IMPORTED_MODULE_3__['createHotspot'])({x: canvasX, y: canvasY})
						},
					}
				...
				Root.prototype.play = function () {
					return __awaiter(this, void 0, void 0, function () {
						...
						return __generator(this, function (_a) {
							switch (_a.label) {
								case 0:
									return [4 /*yield*/, miro.board.widgets.get({type: 'SHAPE'})]
								case 1:
									shapes = _a.sent()
									startHotspotWidget = Object(bottom_panel_controller__WEBPACK_IMPORTED_MODULE_3__['findStartHotspot'])(
										shapes
									)
									if (!startHotspotWidget) return [3 /*break*/, 6]
									return [
										4 /*yield*/,
										Object(bottom_panel_controller__WEBPACK_IMPORTED_MODULE_3__['enterPrototypingMode'])(
											startHotspotWidget
										),
									]
								case 2:
								...
								case 6:
									...
									return [
										4 /*yield*/,
										Object(bottom_panel_controller__WEBPACK_IMPORTED_MODULE_3__['createStartHotspot'])(),
									]
								case 7:
									res = _a.sent()
									if (res) {
				...
				Root.prototype.findScreenIndex = function (screens, screenWidget) {
					var index = screens.findIndex(function (screen) {
						return screen.id === screenWidget.id
					})
				...
				Root.prototype.onExitPrototypingMode = function () {
					return __awaiter(this, void 0, void 0, function () {
						return __generator(this, function (_a) {
							switch (_a.label) {
								case 0:
									return [4 /*yield*/, miro.__setRuntimeState({prototypingMode: false})]
								case 1:
									_a.sent()
									Object(bottom_panel_controller__WEBPACK_IMPORTED_MODULE_3__['exitPrototypingMode'])()
									return [2 /*return*/]
							}
						})
					})
				...
				Root.prototype.render = function () {
					var _this = this
					var editMode = react__WEBPACK_IMPORTED_MODULE_1__['createElement'](
						'div',
						{className: 'edit-mode'},
						react__WEBPACK_IMPORTED_MODULE_1__['createElement'](
							...
							react__WEBPACK_IMPORTED_MODULE_1__[
								'createElement'
							](react_inlinesvg__WEBPACK_IMPORTED_MODULE_4___default.a, {className: 'icon', src: PlayIcon})
						),
						react__WEBPACK_IMPORTED_MODULE_1__['createElement'](
							'div',
							{
								className: 'btn hotspot-button',
								onClick: function () {
									return _this.createHotspot()
								},
							},
							react__WEBPACK_IMPORTED_MODULE_1__[
								'createElement'
							](react_inlinesvg__WEBPACK_IMPORTED_MODULE_4___default.a, {className: 'icon', src: SquareIcon}),
							react__WEBPACK_IMPORTED_MODULE_1__['createElement']('span', null, 'Hotspot')
						),
						react__WEBPACK_IMPORTED_MODULE_1__['createElement'](
							'div',
							{
								...
								onClick: function () {
									return _this.getLink()
								},
							},
							react__WEBPACK_IMPORTED_MODULE_1__[
								'createElement'
							](react_inlinesvg__WEBPACK_IMPORTED_MODULE_4___default.a, {className: 'icon', src: LinkIcon}),
							react__WEBPACK_IMPORTED_MODULE_1__['createElement']('span', null, 'Autoplay link')
						)
					)
					var isFirstScreen = function () {
						return _this.state.screenIndex === 0
					}
					var isLastScreen = function () {
						return _this.state.screenIndex === _this.state.screens.length - 1
					}
					var playMode = react__WEBPACK_IMPORTED_MODULE_1__['createElement'](
						'div',
						{className: 'edit-mode'},
						react__WEBPACK_IMPORTED_MODULE_1__['createElement'](
							'div',
							{
								...
								onClick: function () {
									return _this.onExitPrototypingMode()
								},
							},
						...
						react__WEBPACK_IMPORTED_MODULE_1__['createElement'](
							'div',
							{
								...
								onClick: function () {
									return _this.onPrevScreen()
								},
							},
							react__WEBPACK_IMPORTED_MODULE_1__[
								'createElement'
							](react_inlinesvg__WEBPACK_IMPORTED_MODULE_4___default.a, {className: 'icon', src: ArrowIcon})
						),
						react__WEBPACK_IMPORTED_MODULE_1__['createElement'](
							'div',
					...
					var selectStartScreenMode = react__WEBPACK_IMPORTED_MODULE_1__['createElement'](
						'div',
						{className: 'select-start-screen'},
						'Please select start screen'
					)
					var getView = function () {
						if (_this.state.viewMode === 'edit') {
							return editMode
						} else if (_this.state.viewMode === 'play') {
							return playMode
						} else if (_this.state.viewMode === 'select-start-screen') {
							return selectStartScreenMode
						} else {
							return null
						}
					}
					return react__WEBPACK_IMPORTED_MODULE_1__['createElement']('div', {ref: this.containerRef}, getView())
				}
				return Root
			})(react__WEBPACK_IMPORTED_MODULE_1__['Component'])
			miro.onReady(function () {
				react_dom__WEBPACK_IMPORTED_MODULE_2__['render'](
					react__WEBPACK_IMPORTED_MODULE_1__['createElement'](Root, null),
...
*/
				...
				;(function () {
					...
					function releasePooledEvent(event) {
						...
						!(event instanceof EventConstructor)
							? invariant(false, 'Trying to release an event instance  into a pool of a different type.')
							: void 0
						event.destructor()
						...
						var callTimedOutCallbacks = function () {
							...
							while (currentCallbackConfig !== null) {
								...
								if (_timeoutTime !== -1 && _timeoutTime <= currentTime) {
									...
									if (
										_timeoutTime !== -1 &&
										(updatedNextSoonestTimeoutTime === -1 || _timeoutTime < updatedNextSoonestTimeoutTime)
									) {
...

					{
						...
						validateDOMNesting = function (childTag, childText, ancestorInfo) {
							...
							if (childText != null) {
								!(childTag == null)
									? warning(false, 'validateDOMNesting: when childText is passed, childTag should be null')
									: void 0
								childTag = '#text'
							}
					...
					function pushContextProvider(workInProgress) {
						...
						var memoizedMergedChildContext =
							(instance && instance.__reactInternalMemoizedMergedChildContext) || emptyObject
									...
									if (fiber.type === context && (observedBits & changedBits) !== 0) {
										...
										while (node !== null) {
											...
											if (node.expirationTime === NoWork || node.expirationTime > renderExpirationTime) {
												...
												if (
													alternate !== null &&
													(alternate.expirationTime === NoWork || alternate.expirationTime > renderExpirationTime)
												) {
					...
					function updateContextProvider(current, workInProgress, renderExpirationTime) {
						...
						if (oldProps === null) {
							...
							if (oldProps.value === newProps.value) {
								...
								if (
									(oldValue === newValue && (oldValue !== 0 || 1 / oldValue === 1 / newValue)) ||
  ...
  */
							...
							case HostComponent: {
								...
								if (current !== null && workInProgress.stateNode != null) {
									...
									if (wasHydrated) {
										...
										if (
											finalizeInitialChildren(_instance, type, newProps, rootContainerInstance, _currentHostContext)
										) {
											markUpdate(workInProgress)
										}
							...
							switch (workInProgress.tag) {
								...
								case ClassComponent:
									...
									if (
										...
										((typeof ctor.getDerivedStateFromCatch === 'function' && enableGetDerivedStateFromCatch) ||
											(instance !== null &&
						...
						if (enableProfilerTimer && workInProgress.mode & ProfileMode) {
							...
							while (_child !== null) {
								if (
									...
									(newExpirationTime === NoWork || newExpirationTime > _child.expirationTime)
								) {
					...
					function performWork(minExpirationTime, isAsync, dl) {
						...
						if (isAsync) {
							while (
								...
								(!deadlineDidExpire || recalculateCurrentTime() >= nextFlushedExpirationTime)
							) {
		...
		/***/ function (module, __webpack_exports__, __webpack_require__) {
			'use strict'
			__webpack_require__.r(__webpack_exports__)
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'findStartHotspot', function () {
				return findStartHotspot
			})
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'enterPrototypingMode', function () {
				return enterPrototypingMode
			})
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'exitPrototypingMode', function () {
				return exitPrototypingMode
			})
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'goToWidgetFromHotspot', function () {
				return goToWidgetFromHotspot
			})
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'gotoWidget', function () {
				return gotoWidget
			})
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'isHotspotWidget', function () {
				return isHotspotWidget
			})
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'onCommentCreated', function () {
				return onCommentCreated
			})
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'blinkHotspots', function () {
				return blinkHotspots
			})
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'createStartHotspot', function () {
				return createStartHotspot
			})
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'createHotspot', function () {
				return createHotspot
			})
			/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'findAllScreens', function () {
			...
			function findStartHotspot(shapes) {
				return shapes.find(function (shape) {
					return (
						shape.metadata[config__WEBPACK_IMPORTED_MODULE_0__['APP_ID']] &&
						shape.metadata[config__WEBPACK_IMPORTED_MODULE_0__['APP_ID']].startHotspot
					)
				})
			}
			function enterPrototypingMode(startHotspotWidget) {
				return __awaiter(this, void 0, Promise, function () {
					var shapes, hotspots, hotspotsIsValid, screenWidget, permissions, canEdit
					return __generator(this, function (_a) {
						switch (_a.label) {
							case 0:
								return [4 /*yield*/, miro.board.widgets.get({type: 'SHAPE'})]
							...
							case 2:
								...
								if (!hotspotsIsValid) return [3 /*break*/, 14]
								return [4 /*yield*/, goToWidgetFromHotspot(startHotspotWidget.id)]
							case 3:
								screenWidget = _a.sent()
								if (!screenWidget) return [3 /*break*/, 13]
								return [4 /*yield*/, miro.currentUser.getCurrentBoardPermissions()]
							case 4:
								permissions = _a.sent()
								canEdit = permissions.indexOf('EDIT_CONTENT') !== -1
								if (!canEdit) return [3 /*break*/, 6]
							...
							case 7:
								_a.sent()
								return [4 /*yield*/, miro.board.ui.__limitToolbarMode('commentor')]
							case 8:
								_a.sent()
								return [4 /*yield*/, miro.board.selection.selectWidgets([])]
							case 9:
								_a.sent()
								return [4 /*yield*/, miro.board.__disableLeftClickOnCanvas()]
							case 10:
								_a.sent()
								if (!canEdit) return [3 /*break*/, 13]
			...
			function exitPrototypingMode() {
				return __awaiter(this, void 0, void 0, function () {
					var permissions, canEdit
					return __generator(this, function (_a) {
						switch (_a.label) {
							case 0:
								return [4 /*yield*/, miro.currentUser.getCurrentBoardPermissions()]
							case 1:
								permissions = _a.sent()
								canEdit = permissions.indexOf('EDIT_CONTENT') !== -1
								return [4 /*yield*/, miro.board.viewport.__unmask()]
							case 2:
								_a.sent()
								return [4 /*yield*/, miro.board.ui.__showButtonsPanels('all')]
							case 3:
								_a.sent()
								return [4 /*yield*/, miro.board.ui.__clearToolbarModeLimit()]
							case 4:
								_a.sent()
								return [4 /*yield*/, miro.board.__enableLeftClickOnCanvas()]
							case 5:
								_a.sent()
								if (!canEdit) return [3 /*break*/, 8]
							...
							case 7:
								...
								_a.label = 8
							case 8:
								return [4 /*yield*/, miro.board.ui.closeBottomPanel()] // This command should be last
							case 9:
								_a.sent() // This command should be last
								return [2 /*return*/]
						}
					})
				})
			...
			function hideAllLinks() {
				return __awaiter(this, void 0, void 0, function () {
					...
					return __generator(this, function (_a) {
						switch (_a.label) {
							case 0:
								return [4 /*yield*/, miro.board.widgets.get({type: 'LINE'})]
							case 1:
								lines = _a.sent()
								newLines = lines.map(function (_a) {
									var id = _a.id
									return {
										id: id,
										clientVisible: false,
								...
								return [4 /*yield*/, miro.board.widgets.update(newLines)]
							case 2:
								_a.sent()
								return [2 /*return*/]
						}
			...
			function goToWidgetFromHotspot(hotspotId) {
				return __awaiter(this, void 0, Promise, function () {
					var lines, line, sourceWidget, targetWidget
					return __generator(this, function (_a) {
						switch (_a.label) {
							case 0:
								return [4 /*yield*/, miro.board.widgets.get({type: 'LINE', startWidgetId: hotspotId})]
							case 1:
								lines = _a.sent()
							...
							case 2:
								...
								return [3 /*break*/, 6]
							case 3:
								return [4 /*yield*/, miro.board.widgets.get({id: line.startWidgetId})]
							case 4:
								sourceWidget = _a.sent()[0]
								if (!isHotspotWidget(sourceWidget)) return [3 /*break*/, 6]
								return [4 /*yield*/, miro.board.widgets.get({id: line.endWidgetId})]
							case 5:
								targetWidget = _a.sent()[0]
								return [2 /*return*/, gotoWidget(targetWidget)]
							case 6:
								return [3 /*break*/, 8]
							case 7:
			...
			function gotoWidget(targetWidget) {
				return __awaiter(this, void 0, void 0, function () {
					return __generator(this, function (_a) {
						switch (_a.label) {
							case 0:
					...
					return __generator(this, function (_a) {
						switch (_a.label) {
							case 0:
								...
								return [4 /*yield*/, miro.board.viewport.setViewport(v, padding)]
							case 1:
								_a.sent()
								return [2 /*return*/]
						}
			...
			function isHotspotWidget(widget) {
				return (
					widget.metadata[config__WEBPACK_IMPORTED_MODULE_0__['APP_ID']] &&
					widget.metadata[config__WEBPACK_IMPORTED_MODULE_0__['APP_ID']].hotspot
				)
			}
			function showHotspots() {
				return __awaiter(this, void 0, void 0, function () {
					...
					return __generator(this, function (_a) {
						switch (_a.label) {
							case 0:
								return [4 /*yield*/, getHotspots()]
							case 1:
								hotspots = _a.sent()
								updatingHotspots = hotspots.map(function (h) {
									return {
										id: h.id,
										clientVisible: true,
									}
				...
				return __awaiter(this, void 0, void 0, function () {
					...
					return __generator(this, function (_a) {
						switch (_a.label) {
							...
							case 1:
								hotspots = _a.sent()
								hotspotstoShow = hotspots.map(function (h) {
									return {id: h.id, clientVisible: true}
								})
								miro.board.widgets.update(hotspotstoShow)
								miro.board.widgets.__blinkWidget(hotspotstoShow)
								setTimeout(function () {
									var hotspotsToHide = hotspots.map(function (h) {
										return {id: h.id, clientVisible: false}
									})
						...
						switch (_a.label) {
							...
							case 1:
								...
								lines.forEach(function (line) {
									//for startWidgetId
									var linkedHotspot1 = hotspots.find(function (h) {
										return h.id === line.startWidgetId
									})
									if (linkedHotspot1) {
										hotspotsWithoutLinks = hotspotsWithoutLinks.filter(function (h) {
											return h.id !== linkedHotspot1.id
										})
									}
									//for endWidgetId
									var linkedHotspot2 = hotspots.find(function (h) {
										return h.id === line.endWidgetId
									})
									if (linkedHotspot2) {
										hotspotsWithoutLinks = hotspotsWithoutLinks.filter(function (h) {
											return h.id === linkedHotspot2.id
										})
									}
			...
			function createStartHotspot() {
				return __awaiter(this, void 0, void 0, function () {
					...
					return __generator(this, function (_a) {
						return [
							2 /*return*/,
							miro.board.selection.enterSelectWidgetsMode().then(function (res) {
								return __awaiter(_this, void 0, void 0, function () {
									var _a, screen, flagWidget
									return __generator(this, function (_b) {
										switch (_b.label) {
											case 0:
												if (!res.selectedWidgets.length) return [3 /*break*/, 3]
			...
			function createHotspot(pos) {
				return __awaiter(this, void 0, void 0, function () {
					var _a, width, height, viewport
					return __generator(this, function (_b) {
						switch (_b.label) {
							case 0:
								width = 152
								height = 66
								if (!!pos) return [3 /*break*/, 2]
								return [4 /*yield*/, miro.board.viewport.getViewport()]
							case 1:
								viewport = _b.sent()
								pos = {
					...
					return __generator(this, function (_a) {
						switch (_a.label) {
							...
							case 1:
								...
								lines = allWidgets.filter(function (w) {
									return w.type === 'LINE'
								})
								lines.forEach(function (line) {
									if (
										hotspots.find(function (h) {
											return h.id === line.startWidgetId
										})
									) {
										if (
											line.endWidgetId &&
											!screensIds.some(function (sId) {
												return sId === line.endWidgetId
											})
										) {
								...
								return [
									...
									allWidgets
										.filter(function (w) {
											return screensIds.some(function (sId) {
												return sId === w.id
											})
										})
										.sort(function (a, b) {
			...
			var InlineSVG = /** @class */ (function (_super) {
				...
				function InlineSVG(props) {
					...
					_this.handleError = function (error) {
						...
						var status =
							error.message === 'Browser does not support SVG' ? exports.STATUS.UNSUPPORTED : exports.STATUS.FAILED
						/* istanbul ignore else */
						if (true) {
				...
				InlineSVG.prototype.getElement = function () {
					var _a = this.props,
						...
						onLoad = _a.onLoad,
						loader = _a.loader,
						preProcessor = _a.preProcessor,
						src = _a.src,
						title = _a.title,
						uniqueHash = _a.uniqueHash,
						uniquifyIDs = _a.uniquifyIDs,
						rest = __rest(_a, [
							'baseURL',
							'cacheRequests',
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			function parseChildren(childNodeList, level, options) {
				var children = __spread(childNodeList)
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			Object.defineProperty(exports, '__esModule', {value: true})
			var exenv_1 = __webpack_require__(31)
...
*/
	...
	*/
	 ...
	 */
				var fixedCss = css.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (
					fullMatch,
					origUrl
				) {
		...
		/***/ function (module, exports) {
			module.exports =
				'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#96cdf7" fill-rule="evenodd" stroke="currentColor" stroke-width="2" d="M3 3h18v18H3z"></path></svg>'
		...
		/***/ function (module, exports) {
			module.exports =
				'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill="none" fill-rule="evenodd"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"></circle><path fill="currentColor" d="M10.777 8.518l4.599 3.066a.5.5 0 0 1 0 .832l-4.599 3.066a.5.5 0 0 1-.777-.416V8.934a.5.5 0 0 1 .777-.416z"></path></g></svg>'
		...
		/***/ function (module, exports) {
			module.exports =
				'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="nonzero" d="M15.707 5.707a1 1 0 1 0-1.414-1.414L6.586 12l7.707 7.707a1 1 0 0 0 1.414-1.414L9.414 12l6.293-6.293z"></path></svg>'
