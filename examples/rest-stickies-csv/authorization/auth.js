...
app.get("/", (req, res) => {
  // ---> #1:
  // ---> If an authorization `code` has not already been retrieved from the redirect URL after Miro authorization screen, proceed to #2 (Redirect to Miro authorization URL). Else, proceed to #3 (Requesting access_token using `code`).
  ...
  if (req.query.code) {
    ...
    async function grabToken() {
      try {
        ...
        // Set global variable for access_token values
