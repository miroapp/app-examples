  ...
  "node_modules/cross-fetch/node_modules/node-fetch/lib/index.js"(
    ...
    var Request2 = class {
      constructor(input) {
        ...
        const headers2 = new Headers3(init.headers || input.headers || {});
...
var require_GoTrueApi = __commonJS({
  "node_modules/@supabase/gotrue-js/dist/main/GoTrueApi.js"(exports2) {
    ...
    var GoTrueApi = class {
      ...
      verifyOTP({ email, phone, token: token2, type = "sms" }, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
          try {
            const headers2 = Object.assign({}, this.headers);
            const data = yield (0, fetch_1.post)(
        ...
        if (event === "SIGNED_IN") {
          ...
          (0, cookies_1.setCookies)(
            ...
            [
              ...
              var _a4;
              return {
                name: `${this.cookieName()}-${token2.key}`,
                value: token2.value,
...
var require_PostgrestClient = __commonJS({
  "node_modules/@supabase/postgrest-js/dist/main/PostgrestClient.js"(exports2) {
    ...
    var PostgrestClient = class {
      constructor(
        url,
        { headers: headers2 = {}, schema, fetch: fetch3, throwOnError } = {}
      ) {
        this.url = url;
  ...
  "node_modules/websocket/lib/WebSocketClient.js"(exports2, module2) {
    ...
    WebSocketClient.prototype.validateHandshake = function () {
      ...
      if (
        !(
          headers2["connection"] &&
          headers2["connection"].toLocaleLowerCase() === "upgrade"
        )
      ) {
        this.failHandshake(
      ...
      if (
        !(
          headers2["upgrade"] &&
          headers2["upgrade"].toLocaleLowerCase() === "websocket"
        )
      ) {
        this.failHandshake(
    ...
    var SupabaseClient = class {
      ...
      _getAuthHeaders() {
        ...
        headers2["Authorization"] =
          headers2["Authorization"] || `Bearer ${authBearer}`;
        return headers2;
      }
      _listenForMultiTabEvents() {
        if (
      ...
      _handleTokenChanged(event, token2, source) {
        if (
          ...
          if (source == "STORAGE") this.auth.setAuth(token2);
          this.changedAccessToken = token2;
...
var import_supabase_js2 = __toESM(require_main6());
        ...
        switch (request.redirect) {
          ...
          case "follow": {
            ...
            const responseReferrerPolicy =
              parseReferrerPolicyFromHeader(headers2);
...
// src/utils/github.ts
var import_meta = {};
var token = import_meta.env.VITE_GH_ACCESS_TOKEN;
...
var supabase = (0, import_supabase_js.createClient)(
  import_meta2.env.VITE_DATABASE_URL,
  import_meta2.env.VITE_DATABASE_PUBLIC_KEY
);

// src/utils/index.ts
var getStatusColor = async (status) => {
  let color;
  switch (status) {
    case "To Do":
      color = "#E53935";
...
exports.handler = async function (event) {
  ...
  const gitHubProjectColumn = await fetch2(
