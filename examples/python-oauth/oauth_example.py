...
def main():
    ...
    print(
        "Congratulations on completing a successful OAuth 2.0 authorization code flow :)"
    )
...
def make_api_call(access_token):
    """This function constructs an HTTP request to call the getBoard REST API endpoint, including the access token, as described in Step 4 of the authorization documentation."""
